...
Al['reactions']['n,gamma']['roi_cd'] = 2.8233e-03, 4.1509e-01  # initial guess
...
Rh['reactions']['n,inelastic']['roi'] = 4.4469e+05, 5.1947e+06  # initial guess
...
In['reactions']['n,gamma']['roi_cd'] = 7.0021e-03, 1.6130e+00  # initial guess
...
In['reactions']['n,inelastic']['roi_cd'] = 1.3314e+06, 5.9607e+06  # initial guess
